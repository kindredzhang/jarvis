#!/usr/bin/env python3
"""
Minimal validator for skill folders.
"""
...
ALLOWED_FRONTMATTER_KEYS = {"name", "description", "metadata", "always", "license", "allowed-tools"}
...
def _parse_simple_frontmatter(frontmatter_text):
    parsed = {}
    current_key = None
    multiline_key = None
...
def _load_frontmatter(frontmatter_text):
    if yaml is not None:
        try:
...
def _validate_skill_name(name, folder_name):
