...
[TODO: Steps, patterns, or decision trees depending on skill type]
...
def main():
    ...
    if len(skill_name) > MAX_SKILL_NAME_LENGTH:
        print(f"[ERROR] Skill name '{skill_name}' is too long ({len(skill_name)} characters). Max is {MAX_SKILL_NAME_LENGTH}.")
        sys.exit(1)
    ...
    path = args.path
    print(f"Initializing skill: {skill_name} at {path}")
